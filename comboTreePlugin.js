...
;(function ( $, window, document, undefined ) {
    ...
    ComboTree.prototype.createSourceItemHTML = function (sourceItem) {
        ...
        if (this.options.isMultiple)
            itemHtml += '<span data-id="' + sourceItem.id + '" data-value="' + sourceItem.value + '" class="comboTreeItemTitle"><input type="checkbox">' + sourceItem.title + '</span>';
        else
            itemHtml += '<span data-id="' + sourceItem.id + '" data-value="' + sourceItem.value + '" class="comboTreeItemTitle">' + sourceItem.title + '</span>';
